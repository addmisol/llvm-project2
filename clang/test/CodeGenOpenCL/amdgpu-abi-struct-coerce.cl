...
// CHECK: void @kernel_empty_struct_arg(ptr addrspace(4) nofree noundef readnone byref(%struct.empty_struct) align 1 captures(none) {{%.+}})
...
// CHECK: void @kernel_struct_arg(ptr addrspace(4) nofree noundef readonly byref(%struct.struct_arg) align 4 captures(none) {{%.+}})
...
// CHECK: void @kernel_struct_padding_arg(ptr addrspace(4) nofree noundef readonly byref(%struct.struct_padding_arg) align 8 captures(none) {{%.+}})
...
// CHECK: void @kernel_test_struct_of_arrays_arg(ptr addrspace(4) nofree noundef readonly byref(%struct.struct_of_arrays_arg) align 4 captures(none) {{%.+}})
...
// CHECK: void @kernel_struct_of_structs_arg(ptr addrspace(4) nofree noundef readonly byref(%struct.struct_of_structs_arg) align 4 captures(none) {{%.+}})
...
// CHECK: void @kernel_single_array_element_struct_arg(ptr addrspace(4) nofree noundef readonly byref(%struct.single_array_element_struct_arg) align 4 captures(none) {{%.+}})
...
// CHECK: void @kernel_single_struct_element_struct_arg(ptr addrspace(4) nofree noundef readonly byref(%struct.single_struct_element_struct_arg) align 8 captures(none) {{%.+}})
...
// CHECK: void @kernel_different_size_type_pair_arg(ptr addrspace(4) nofree noundef readonly byref(%struct.different_size_type_pair) align 8 captures(none) {{%.+}})
...
// CHECK: void @func_flexible_array_arg(ptr addrspace(5) nofree noundef readnone byval(%struct.flexible_array) align 4 captures(none) %arg)
...
// CHECK: define{{.*}} void @func_ret_struct_arr32(ptr addrspace(5) dead_on_unwind noalias nofree writable writeonly sret(%struct.struct_arr32) align 4 captures(none) initializes((0, 128)) %agg.result)
...
// CHECK: define{{.*}} void @func_ret_struct_arr33(ptr addrspace(5) dead_on_unwind noalias nofree writable writeonly sret(%struct.struct_arr33) align 4 captures(none) initializes((0, 132)) %agg.result)
...
// CHECK: define{{.*}} void @func_flexible_array_ret(ptr addrspace(5) dead_on_unwind noalias nofree writable writeonly sret(%struct.flexible_array) align 4 captures(none) initializes((0, 4)) %agg.result)
...
// CHECK: define{{.*}} void @func_reg_state_hi(<4 x i32> noundef %arg0, <4 x i32> noundef %arg1, <4 x i32> noundef %arg2, i32 noundef %arg3, i32 noundef %arg4, ptr addrspace(5) nofree noundef readnone byref(%struct.struct_arg) align 4 captures(none) %{{.*}})
...
// CHECK: define{{.*}} void @func_reg_state_num_regs_nested_struct(<4 x i32> noundef %arg0, i32 noundef %arg1, i32 %arg2.coerce0, %struct.nested %arg2.coerce1, i32 %arg3.coerce0, %struct.nested %arg3.coerce1, ptr addrspace(5) nofree noundef readnone byref(%struct.num_regs_nested_struct) align 8 captures(none) %{{.*}})
...
// CHECK: define{{.*}} void @func_large_struct_padding_arg_store(ptr addrspace(1) nofree noundef writeonly captures(none) initializes((0, 56)) %out, ptr addrspace(5) nofree noundef readonly byref(%struct.large_struct_padding) align 8 captures(none) %{{.*}})
...
// CHECK: define{{.*}} void @v3i32_pair_reg_count(ptr addrspace(5) nofree noundef readnone captures(none) %arg0, <3 x i32> %arg1.coerce0, <3 x i32> %arg1.coerce1, <3 x i32> noundef %arg2, <3 x i32> %arg3.coerce0, <3 x i32> %arg3.coerce1, <3 x i32> noundef %arg4, float noundef %arg5)
...
// CHECK: define{{.*}} void @v4i16_pair_reg_count_over(<4 x i16> noundef %arg0, <4 x i16> noundef %arg1, <4 x i16> noundef %arg2, <4 x i16> noundef %arg3, <4 x i16> noundef %arg4, <4 x i16> noundef %arg5, <4 x i16> noundef %arg6, ptr addrspace(5) nofree noundef readnone byref(%struct.struct_4regs) align 4 captures(none) %{{.*}})
...
// CHECK: define{{.*}} void @v3i16_reg_count_over(<3 x i16> noundef %arg0, <3 x i16> noundef %arg1, <3 x i16> noundef %arg2, <3 x i16> noundef %arg3, <3 x i16> noundef %arg4, <3 x i16> noundef %arg5, <3 x i16> noundef %arg6, ptr addrspace(5) nofree noundef readnone byref(%struct.struct_4regs) align 4 captures(none) %{{.*}})
...
// CHECK: define{{.*}} void @v2i8_reg_count_over(<2 x i8> noundef %arg0, <2 x i8> noundef %arg1, <2 x i8> noundef %arg2, <2 x i8> noundef %arg3, <2 x i8> noundef %arg4, <2 x i8> noundef %arg5, i32 noundef %arg6, ptr addrspace(5) nofree noundef readnone byref(%struct.struct_4regs) align 4 captures(none) %{{.*}})
